    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Buang Library</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To Buang Library!</div>
                <div class="intro-heading">Ke Leboga go kopana le lena</div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Library</h4>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/joao.jpg" class="img-responsive img-circle" alt="">
                        <h4>Joao Nzango</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/buang.jpg" class="img-responsive img-circle" alt="">
                        <h4>Buang Moshidi</h4>
                        <p class="text-muted">Lead Documentation Writter</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/lucia.jpg" class="img-responsive img-circle" alt="">
                        <h4>Lucia Mafala</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/gladys.jpg" class="img-responsive img-circle" alt="">
                        <h4>Gladys Sibiya</h4>
                        <p class="text-muted">Co Documentation Writter</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/kamo.jpg" class="img-responsive img-circle" alt="">
                        <h4>Kamogelo Pasha</h4>
                        <p class="text-muted">Co Documentation Writter</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input namw="email" type="email" class="form-control" placeholder="Your Email *" id="email" required data-validation-required-message="Please enter your email address.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
