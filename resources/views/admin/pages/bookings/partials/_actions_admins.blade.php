  ...
  <a class="btn btn-s btn-dangerr" href="{{ route("admin.bookings.edit",$value->id) }}"><i class="fa fa-edit text-warning" data-toggle="tooltip" data-placement="top" title="edit"></i></a>
